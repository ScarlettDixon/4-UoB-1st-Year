...
if __name__ == '__main__':
    key = "secret_k"
    key =  binvalue(0x0000000000000000,8)
    #print(test)
    #key = test
    text= "Hello wo"
    textx = binvalue(0x0000000000000000,8)
    texty= binvalue(0x0008000000000000,8)
    #print(test2)
    d = des()
    rx = d.encrypt(key,textx)
    r2x = d.decrypt(key,rx)
    print("Ciphered: %r" % rx)
    print("Deciphered: ", r2x)
    ry = d.encrypt(key,textx)
    r2y = d.decrypt(key,ry)
    print("Ciphered: %r" % ry)
    print("Deciphered: ", r2y)